...
class JDate
{
    public static function convertGregorianStringDateTimeToJalali($datetime)
    {
        ...
        return PNumber::en2FaDigit($datetime);
    }

    public static function convertGregorianStringDateToJalali($date)
    {
        $date = str_replace('/', '-', $date);
        list($year, $month, $day) = explode('-', $date);
        list($year, $month, $day) = self::gregorian_to_jalali($year, $month, $day);
        $date = $year . '/' . $month . '/' . $day;
        return PNumber::en2FaDigit($date);
    }

    public static function convertJalaliStringDateTimeToGregorian($datetime)
    {
        $datetime = PNumber::fa2EnDigit($datetime);
        @list($date, $time) = explode(' ', $datetime);
        $date = str_replace('/', '-', $date);
        list($year, $month, $day) = explode('-', $date);
    ...
    public static function convertJalaliStringDateToGregorian($date)
    {
        $datetime = PNumber::fa2EnDigit($date);
        $date = str_replace('/', '-', $date);
        list($year, $month, $day) = explode('-', $date);
        list($year, $month, $day) = self::jalali_to_gregorian($year, $month, $day);
        $date = $year . '/' . $month . '/' . $day;
    ...
    private static function jgetdate($timestamp = '', $none = '', $timezone = 'Asia/Tehran', $tn = 'en')
    {
    ...
    private static function jcheckdate($jm, $jd, $jy)
    {
    ...
    private static function jdate_words($array, $mod = '')
    {
    ...
    private static function jalali_to_gregorian($jy, $jm, $jd, $mod = '')
    {
